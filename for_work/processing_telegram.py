...
def decod_b(data):
    '''декодирует байтовую строку из телеграммы'''
    try:
...
def get_data_for_info_pusk(bufr_message, kye=0):
    '''получаем декодированную телеграмму, на выходе списко значений для записи в базу данных '''
    ...
    for file_name in files:
        try:
            ...
            try:
                ...
                log_mistake(file_name, f'не декодирован и не перенесен в папку с ошибками, {ex}\n')
                print('oy!')
            continue
